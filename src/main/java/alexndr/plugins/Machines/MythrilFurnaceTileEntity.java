...
public class MythrilFurnaceTileEntity extends TileEntity implements ISidedInventory
{
    ...
    private static int fuelMultiplier = Settings.mythrilFurnaceFuelMultiplier.asInteger();
    ...
    public static int getItemBurnTime(ItemStack par0ItemStack)
    {
        ...
        else
        {
            ...
            if (item instanceof ItemHoe && ((ItemHoe) item).getToolMaterialName().equals("WOOD")) return 200 * fuelMultiplier;
            ...
            return GameRegistry.getFuelValue(par0ItemStack) * fuelMultiplier;
        }
    }
