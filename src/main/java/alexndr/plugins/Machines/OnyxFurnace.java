...
public class OnyxFurnace extends BlockContainer
{
	 ...
	 * @return OnyxFurnace.
	 */
	public OnyxFurnace setConfigValues(ConfigBlock entry) {
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("machines:" + "onyx_furnace_side");
        this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "machines:" + "onyx_furnace_front_lit" : "machines:" + "onyx_furnace_front");
        this.furnaceIconTop = par1IconRegister.registerIcon("machines:" + "onyx_furnace_top");
    }
