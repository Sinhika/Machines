...
{	
	 ...
	 * @return MythrilFurnace.
	 */
	public MythrilFurnace setConfigValues(ConfigBlock entry) {
		this.setHardness(entry.getHardness());
		this.setResistance(entry.getResistance());
		this.setLightLevel(this.isActive ? entry.getLightValue() : 0.0F);
		return this;
	}
    ...
    {
        this.blockIcon = par1IIconRegister.registerIcon("machines:" + "mythril_furnace_side");
        this.furnaceIconFront = par1IIconRegister.registerIcon(this.isActive ? "machines:" + "mythril_furnace_front_lit" : "machines:" + "mythril_furnace_front");
        this.furnaceIconTop = par1IIconRegister.registerIcon("machines:" + "mythril_furnace_top");
    }
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            par5EntityPlayer.openGui(Machines.INSTANCE, 0, par1World, par2, par3, par4);
