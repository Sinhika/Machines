...
public class MythrilFurnaceTileEntity extends SomewhatAbstractFurnaceBlockEntity
{
	...
	{
		super(ModTileEntityTypes.mythril_furnace.get(), blockpos, blockstate, RecipeType.SMELTING);
	...
	{
		return new MythrilFurnaceContainer(containerId, inventory, this, this.dataAccess);
	}
} // end class
