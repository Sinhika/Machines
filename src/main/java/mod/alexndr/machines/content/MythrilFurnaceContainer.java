...
public class MythrilFurnaceContainer extends Container 
{
	...
	public final MythrilFurnaceTileEntity tileEntity;
	...
	{
		super(ModContainerTypes.mythril_furnace.get(), windowId);
		...
		this.addSlot(new SlotItemHandler(tileEntity.inventory, MythrilFurnaceTileEntity.FUEL_SLOT, 56, 53));
		this.addSlot(new SlotItemHandler(tileEntity.inventory, MythrilFurnaceTileEntity.INPUT_SLOT, 56, 17));
		this.addSlot(new SlotItemHandler(tileEntity.inventory, MythrilFurnaceTileEntity.OUTPUT_SLOT, 116, 35));
	...
	private static MythrilFurnaceTileEntity getTileEntity(final PlayerInventory playerInventory, final PacketBuffer data) 
	{
