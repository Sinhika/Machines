...
public class OnyxFurnaceContainer extends Container 
{
	...
	public final OnyxFurnaceTileEntity tileEntity;
	...
	{
		super(ModContainerTypes.onyx_furnace.get(), windowId);
		...
		this.addSlot(new SlotItemHandler(tileEntity.inventory, OnyxFurnaceTileEntity.FUEL_SLOT, 56, 53));
		this.addSlot(new SlotItemHandler(tileEntity.inventory, OnyxFurnaceTileEntity.INPUT_SLOT, 56, 17));
		this.addSlot(new SlotItemHandler(tileEntity.inventory, OnyxFurnaceTileEntity.OUTPUT_SLOT, 116, 35));
	...
	private static OnyxFurnaceTileEntity getTileEntity(final PlayerInventory playerInventory, final PacketBuffer data) 
	{
	...
	public boolean canInteractWith(@Nonnull final PlayerEntity player) {
		return isWithinUsableDistance(canInteractWithCallable, player, ModBlocks.onyx_furnace.get());
	}
