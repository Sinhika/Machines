 ...
 * @author Cadiboo
 */
public class MythrilFurnaceScreen extends ContainerScreen<MythrilFurnaceContainer> 
{
	...
	protected void drawGuiContainerBackgroundLayer(final float partialTicks, final int mouseX, final int mouseY) {
		...
		final MythrilFurnaceTileEntity tileEntity = container.tileEntity;
	...
	private int getSmeltTimeScaled() {
		final MythrilFurnaceTileEntity tileEntity = this.container.tileEntity;
