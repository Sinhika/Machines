...
public class OnyxFurnaceContainer extends VeryAbstractFurnaceMenu 
{
	 ...
	 */
	public OnyxFurnaceContainer(final int windowId, final Inventory playerInventory, final BlockPos pos, Player playerEntity) 
	{
		super(ModContainerTypes.onyx_furnace.get(), windowId, pos, playerInventory, playerEntity, RecipeType.SMELTING);
